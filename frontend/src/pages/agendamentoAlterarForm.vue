            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <input
                  type="text"
                  class="form-control"
                  placeholder="Digite as Sintomas"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input
                type="text"
                class="form-control"
                placeholder="Digite as Doenças Existentes"
  ...
  methods: {
    ...
    pegarAgendamento() {
      ...
      AgendamentoService.buscarAgendamentoPeloId(this.IdAgendamento)
        .then(resposta => {
          //debugger;
          this.agendamento = resposta.data;

          this.horario = this.agendamento.Horario.split("T")[1];
          this.agendamento.DataConsulta = this.agendamento.DataConsulta.split(
            "T"
          )[0];

          this.paciente = this.agendamento.PacienteId + "-" + resposta.data.Pacientes.Nome;

          this.agendamento.Anaminese.PartesCorpo = this.partesCorpo[resposta.data.Anaminese.PartesCorpo];
        })
        .catch(resposta => {
